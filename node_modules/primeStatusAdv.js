...
postQueryResult = function(row, msgbody)
{
	...
	{
		console.log("parse failed for: " + row.ipaddr);
		console.log("msgbody:  " + msgbody);
		return;
	}

	if (row.hostname != postObj.hostname || row.platform != postObj.platform || row.totalmem != postObj.totalmem)
	{
		...
		myl.updateHostname(row.ipaddr, postObj.hostname, postObj.platform, postObj.totalmem);
	}
